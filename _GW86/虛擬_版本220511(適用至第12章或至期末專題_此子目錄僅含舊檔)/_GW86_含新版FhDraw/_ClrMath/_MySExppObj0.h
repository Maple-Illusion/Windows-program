...
public:
  ...
  double icos(double theta_x, int i) {
      static double summ = 0;
      if (i == 0) summ = 0;
      summ = summ + (pow(-1, i) * pow(theta_x, (2 * i)) / fac(2 * i));
      return summ;
  ...
  double isin(double theta_x, int i) {
      static double summ = 0;
      if (i == 0) summ = 0;
      summ = summ + (pow(-1, i) * pow(theta_x, (2 * i + 1)) / fac(2 * i + 1));
      return summ;
