...
#include "_fp12.4_MyContainer0.h"
#include "_fp12.4_MyDialog3.h"
...
namespace ghctn_fcmpatt0 {
	...
	public:
	  MyForm0(void) {
		InitializeComponent();
        theContainer0 = gcnew MyContainer0;
        this->theContainer0->theForm0 = this;
	  };
	  ~MyForm0() {
...
private: System::Void cmdToolStripMenuItem_Click
  ...
  this->theContainer0->theDialog3 = gcnew MyDialog3(this->theContainer0);
  this->theContainer0->theDialog3->Show();
}
...
private: System::Void clearToolStripMenuItem_Click
	  (System::Object^ sender, System::EventArgs^ e) {
    pictureBox1->Refresh();
	if (this->theContainer0->theDialog3)
	  this->theContainer0->theDialog3->Refresh();
}
